...
export const tauriApi = {
  ...
  startProcess: (runConfigId: string) => invoke<string>('start_process', { runConfigId: runConfigId }),
  runUntrustedOnce: (runConfigId: string) => invoke<string>('run_untrusted_once', { runConfigId: runConfigId }),
